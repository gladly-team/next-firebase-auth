...
import transform from 'codemod/rename-authuser-withauthuserssr'
...
const transformName = `rename-authuser-withauthuserssr`

describe('withAuthUserSSR argument property change: AuthUser -> user', () => {
